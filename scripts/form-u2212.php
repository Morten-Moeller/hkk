...
$form = array(
	'subject' => 'Privatlizenz Formular Übermittlung',
	...
	'fields' => array(
		'custom_U2249' => array(
			'order' => 1,
			'type' => 'string',
			'label' => 'Name (Besteller)',
			'required' => true,
			'errors' => array(
				'required' => 'Feld „Name (Besteller)“ ist erforderlich.'
			)
		),
		'Email' => array(
			'order' => 2,
			'type' => 'email',
			'label' => 'E-Mail (Besteller)',
			'required' => true,
			'errors' => array(
				'required' => 'Feld „E-Mail (Besteller)“ ist erforderlich.',
				'format' => 'Die E-Mail-Adresse in Feld „E-Mail (Besteller)“ ist ungültig.'
			)
		),
		'custom_U2231' => array(
			'order' => 3,
			'type' => 'string',
			'label' => 'Firma / Bibliothek',
			'required' => false,
			'errors' => array(
			)
		),
		...
		'custom_U2437' => array(
			'order' => 8,
			'type' => 'string',
			'label' => 'Stückzahl zu je 19,90€ incl. MwSt',
			'required' => true,
			'errors' => array(
				'required' => 'Feld „Stückzahl zu je 19,90€ incl. MwSt“ ist erforderlich.'
			)
		),
		'custom_U2461' => array(
			'order' => 9,
